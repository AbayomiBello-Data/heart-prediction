...
def main():
    ...
    diabetes= st.number_input('Diabetes | Yes or No | yes = 1 and n0 = 0', min_value=0, step=1)
    ejection_fraction = st.number_input('Percentage of blood leaving the heart', min_value=0, step=1)
    high_blood_pressure = st.number_input('Hypertensive | Yes or No | yes = 1 and n0 = 0', min_value=0, step=1)
